...
#' @importFrom magrittr "%>%"
#' @export
chain_old <- function(.data, lastCompleteYear = 2016, cypColumn = "CYP", pypColumn = "PYP",
  ...
  quarterlyCVM <- calcScalingFactor_old(withQuarter, lastCompleteYear, cypColumn, pypColumn)
  quarterlyCVM <- calcUnconstrainedCVM_old(quarterlyCVM, lastCompleteYear, cypColumn, pypColumn)

  # calculate the annual cvm, based on the chain type
  annualCVM <- switch(chainType,
                      "Stock" = calcAnnualCVMStock_old(withQuarter, lastCompleteYear,
                                                   cypColumn, pypColumn),
                      "Flow" = calcAnnualCVMFlow_old(withQuarter, lastCompleteYear,
                                                 cypColumn, pypColumn))
...
calcScalingFactor_old <- function(.data, lastCompleteYear, cypColumn = "CYP",
                              pypColumn = "PYP"){
  # .data <- withQuarter
...
calcUnconstrainedCVM_old <- function(.data, lastCompleteYear, cypColumn = "CYP",
                                 pypColumn = "PYP"){
  # .data <- quarterlyCVM
  result <- .data %>%
...
calcAnnualCVMFlow_old <- function(.data, lastCompleteYear, cypColumn = "CYP", pypColumn = "PYP"){
...
#'
#' @return A data.frame where for each year there is a CVM value
calcAnnualCVMStock_old <- function(.data, lastCompleteYear, cypColumn = "CYP", pypColumn = "PYP"){
